...
from utils import load_obj,IdDropper,RemoveOutliers,FeatureEncoder,FeatureScaling
...
class PredictionPipelineConfig():
    ...
    preprocessor_file_path=os.path.join(os.getcwd(),"web_app","preprocessor.pkl")
    model_file_path=os.path.join(os.getcwd(),"web_app","model.pkl")
...
class PredictionPipeline():
    ...
    def predict(self,features):
        ...
        print(self.predictionPipeline_config.preprocessor_file_path)
        ...
        prediction_probability=model.predict_proba(cleaned_features)
